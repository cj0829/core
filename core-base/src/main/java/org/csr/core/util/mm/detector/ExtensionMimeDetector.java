...
import org.csr.core.util.mm.MimeException;
import org.csr.core.util.mm.MimeType;
 ...
 * <code>org.csr.core.util.mm.mime-types.properties</code>.</li>
 ...
 * This file resides in the org.csr.media.util.mime-types.properties file and is not guaranteed to be correct or contain all the known mappings for a file
...
public class ExtensionMimeDetector extends MimeDetector {
	...
	static Logger log = LoggerFactory.getLogger(ExtensionMimeDetector.class);
	// Extension MimeTypes
	 ...
	 * org.csr.media.mime.mime-types.properties. 2. Locates and loads a file named
	...
	private static void initMimeTypes() {
		...
		try {
			...
			try {
				...
				is = MimeUtil.class.getClassLoader().getResourceAsStream("com/pmt/core/util/mm/mime-types.properties");
				if(is != null) {
