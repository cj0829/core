/*
 * File   : $Source: ExtractorRtf.java,v $
 ...
 * @since 6.0.0 
 */
public final class ExtractorRtfImpl extends ExtractorTextImpl {

	/** Static member instance of the extractor. */
	private static final ExtractorRtfImpl INSTANCE = new ExtractorRtfImpl();
