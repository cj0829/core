 ...
 * @since 6.0.0 
 */
public interface ExtractorText {

	ExtractionResult extractText(String content) throws Exception;
	 ...
	 */
	ExtractionResult extractText(byte[] content) throws Exception;
	 ...
	 * @throws Exception if the text extration fails
	 */
	ExtractionResult extractText(byte[] content, String encoding) throws Exception;
	 ...
	 * @throws Exception if the text extration fails
	 */
	ExtractionResult extractText(InputStream in) throws Exception;
	 ...
	 * @throws Exception if the text extration fails
	 */
	ExtractionResult extractText(InputStream in, String encoding) throws Exception;
}