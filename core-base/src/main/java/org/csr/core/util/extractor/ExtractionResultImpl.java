...
public class ExtractionResultImpl implements ExtractionResult {
	 ...
	 */
	public ExtractionResultImpl(String content) {
	 ...
	 */
	public ExtractionResultImpl(String content, Map metaInfo) {
	...
	/**
	 * @see org.ExtractionResult.search.extractors.I_CmsExtractionResult#getContent()
	 */
	...
	/**
	 * @see org.ExtractionResult.search.extractors.I_CmsExtractionResult#getMetaInfo()
	 */
	...
	/**
	 * @see org.ExtractionResult.search.extractors.I_CmsExtractionResult#release()
	 */
	public void release() {
