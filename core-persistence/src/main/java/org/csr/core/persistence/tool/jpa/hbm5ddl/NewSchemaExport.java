...
public class NewSchemaExport {
	...
	/**
	 * Builds a NewSchemaExport object.
	 *
	 * @param metadata The metadata object holding the mapping info to be exported
	 */
	public NewSchemaExport(MetadataImplementor metadata) {
	 ...
	 * @param metadata The metadata object holding the mapping info to be exported
	 */
	public NewSchemaExport(MetadataImplementor metadata, boolean createNamespaces) {
	 ...
	 * @param metadata The metadata object holding the mapping info to be exported
	 */
	public NewSchemaExport(ServiceRegistry serviceRegistry, MetadataImplementor metadata) {
		this(
				new SuppliedConnectionProviderConnectionHelper(serviceRegistry.getService( ConnectionProvider.class )),
				serviceRegistry,
				metadata,
				false
		);
	 ...
	 * @param metadata The metadata object holding the mapping info to be exported
	 */
	public NewSchemaExport(ServiceRegistry serviceRegistry, MetadataImplementor metadata, boolean createNamespaces) {
		this(
				new SuppliedConnectionProviderConnectionHelper(serviceRegistry.getService( ConnectionProvider.class )),
				serviceRegistry,
				metadata,
	...
	private NewSchemaExport(
		...
		new PersistentComment(metadata,serviceRegistry).setTableColumnCommentScript();
	...
	/**
	 * Create a NewSchemaExport for the given Metadata, using the supplied connection for connectivity.
	 *
	 * @param metadata The metadata object holding the mapping info to be exported
	 ...
	 */
	public NewSchemaExport(MetadataImplementor metadata, Connection connection) throws HibernateException {
	 ...
	 * @return this
	 */
	public NewSchemaExport setOutputFile(String filename) {
		outputFile = filename;
		return this;
	}
	 ...
	 * @return this
	 */
	public NewSchemaExport setDelimiter(String delimiter) {
	 ...
	 * @return this
	 */
	public NewSchemaExport setFormat(boolean format) {
	 ...
	 * @return this
	 */
	public NewSchemaExport setImportSqlCommandExtractor(ImportSqlCommandExtractor importSqlCommandExtractor) {
	 ...
	 * @return this
	 */
	public NewSchemaExport setHaltOnError(boolean haltOnError) {
	...
	public void execute(Target output, Type type) {
		if ( ( outputFile == null && output == Target.NONE ) || type == NewSchemaExport.Type.NONE ) {
			return;
		}
		exceptions.clear();
	...
	public static void main(String[] args) {
		try {
			...
			try {
				...
				NewSchemaExport schemaExport = new NewSchemaExport( serviceRegistry, metadata, commandLineArgs.exportSchemas )
