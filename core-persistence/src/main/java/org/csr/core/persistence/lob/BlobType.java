 ...
 * @author Brett Meyer
 */
public class BlobType<T extends Serializable> extends AbstractSingleColumnStandardBasicType<T> implements DynamicParameterizedType {
	...
	public void setParameterValues(Properties parameters) {
		...
		if ( reader != null ) {
			...
			if ( className == null ) {
				throw new MappingException( "No class name defined for type: " + BlobType.class.getName() );
			}
			try {
