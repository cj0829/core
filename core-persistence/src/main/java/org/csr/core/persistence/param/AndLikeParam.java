 ...
 * 
 */
public class AndLikeParam extends AndParam {
	public AndLikeParam(String key, Object value) {
		super(key, value);
		compare = Compare.LIKE;
	}

	public AndLikeParam(String key, Object value, Class<?> property) {
	...
	@Override
	public String hql() {
		String newValue = ObjUtil.toString(value);
		if (ObjUtil.isNotBlank(newValue)) {
			return "'%" + value + "%'";
		}
		return "";
	}
